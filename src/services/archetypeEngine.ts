...
import { calcDeckRatio, calcCostCurve, calcDeckSynergy as calcDeckSynergyScore } from '@/utils/deckUtils'
...
export function analyzeCostCurve(deck: DeckCard[]): CostCurveAnalysis {
  ...
  const highCostRatio = (curve[2] || 0) + (curve[3] || 0) + (curve[4] || 0)
