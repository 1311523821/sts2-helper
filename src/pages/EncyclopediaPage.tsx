        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="relative">
            <input type="text" placeholder="搜索卡牌名称、描述、标签..." value={search}
              onChange={e => setSearch(e.target.value)} className="input-field pl-10" aria-label="搜索卡牌" />
        ...
        <div className="p-6 border-b border-warm-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 id="card-detail-title" className="text-xl font-bold text-text-primary">{card.name}</h2>
            ...
            <div className="flex items-center gap-2">
              ...
              <button ref={closeButtonRef} onClick={onClose} className="w-8 h-8 rounded-full bg-warm-100 text-text-muted hover:bg-warm-200 flex items-center justify-center" aria-label="关闭详情">✕</button>
            </div>
          </div>
        </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {card.keywords.map(kw => {
                  ...
                  return (
                    <span key={kw} className="inline-flex items-center gap-1 text-xs px-2.5 py-1 rounded-lg bg-xm-light text-xm-primary font-medium">{kwData?.icon} {kwData?.name || kw}</span>
                  )
                })}
              </div>
            </div>
